...
from duckduckgo_search import DDGS  # <-- NEW: Import DuckDuckGo

# <-- NEW: Define our custom, free search tool
# No imports needed for this!

def free_web_search(query: str) -> str:
    """Searches the web for current events or news."""
    try:
        with DDGS() as ddgs:
...
root_agent = LlmAgent(
        ...
        # <-- NEW: Pass the custom function instead of google_search
